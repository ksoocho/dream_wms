	...
	&& isSet($_POST['user_id']))
{
	...
	$xfer_lpn_code = mysqli_real_escape_string($db,$_POST['xfer_lpn_code']); 
	...
	$db->query("SET @p_xfer_lpn_code     = " . "'" . $xfer_lpn_code . "'");
	...
	// Call sproc 
	if(!$db->query("call pr_wms_txn_lpn_split(@p_org_id, 
	                                          @p_subinv_code, 
	                                          @p_locator_code, 
	                                          @p_item_code, 
	                                          @p_lpn_code, 
