...
if(isSet($_POST['org_id']) 
	&& isSet($_POST['from_subinv_code'])
	&& isSet($_POST['from_loc_code'])
	&& isSet($_POST['to_subinv_code'])
	&& isSet($_POST['to_loc_code'])
	...
	&& isSet($_POST['user_id']))
{
	...
	$from_subinv_code = mysqli_real_escape_string($db,$_POST['from_subinv_code']); 
	$from_loc_code    = mysqli_real_escape_string($db,$_POST['from_loc_code']); 
	$to_subinv_code   = mysqli_real_escape_string($db,$_POST['to_subinv_code']); 
	$to_loc_code      = mysqli_real_escape_string($db,$_POST['to_loc_code']); 
	...
	$db->query("SET @p_locator_code      = " . "'" . $from_loc_code . "'");
	$db->query("SET @p_xfer_subinv_code  = " . "'" . $to_subinv_code . "'");
	$db->query("SET @p_xfer_locator_code = " . "'" . $to_loc_code . "'");
	...
	// Call sproc 
	if(!$db->query("call pr_wms_txn_xfer_sub(@p_org_id, 
	                                          @p_subinv_code, 
	                                          @p_locator_code, 
	                                          @p_xfer_subinv_code, 
	                                          @p_xfer_locator_code, 
